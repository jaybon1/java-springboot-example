...
public class TodoServiceApiV1 {
    ...
    public ResponseEntity<?> getTodoTableData(CustomUserDetails customUserDetails) {

        List<TodoEntity> todoEntityList = todoRepository
                .findByUserEntity_IdxAndDeleteDateIsNull(customUserDetails.getUser().getIdx());
    ...
    @Transactional
    public ResponseEntity<?> insertTodoTableData(ReqTodoTableInsertDTO dto, CustomUserDetails customUserDetails) {
        ...
        Optional<UserEntity> userEntityOptional = userRepository
                .findByIdxAndDeleteDateIsNull(customUserDetails.getUser().getIdx());
    ...
    public ResponseEntity<?> updateTodoTableData(Long todoIdx, ReqTodoTableUpdateDoneYnDTO dto,
        ...
        if (!todoEntity.getUserEntity().getIdx().equals(customUserDetails.getUser().getIdx())) {
    ...
    @Transactional
    public ResponseEntity<?> deleteTodoTableData(Long todoIdx, CustomUserDetails customUserDetails) {
